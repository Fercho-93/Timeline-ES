...
console.log("\nReto diario");
{
  ...
  click(uno, '[data-format="solo"]'); click(uno, '[data-action="solo"]');
  click(uno, '[data-action="start-free"]');
  const otro = boot();
  abreMazo(otro, "historia", "history");
  click(otro, '[data-format="solo"]'); click(otro, '[data-action="solo"]');
  click(otro, '[data-action="start-daily"]');
  const tercero = boot();
  abreMazo(tercero, "historia", "history");
  click(tercero, '[data-format="solo"]'); click(tercero, '[data-action="solo"]');

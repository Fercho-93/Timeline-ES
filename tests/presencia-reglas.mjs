...
const ref=uid=>doc(env.authenticatedContext(uid, {email_verified:true, firebase:{sign_in_provider:'password'}}).firestore(),'rooms','PRES1234');
const presence=(uid,other=uid)=>doc(env.authenticatedContext(uid, {email_verified:true, firebase:{sign_in_provider:'password'}}).firestore(),'rooms','PRES1234','presence',other);

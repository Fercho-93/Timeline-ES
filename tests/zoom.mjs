...
for (const screen of ['game','solo','online-game']) {
  ...
  for(const [index,scale] of [0.8,1,1.2].entries()) {
...
console.log('Zoom: tres porcentajes, límites, dimensiones reservadas, resize, selección, Fantasma y repintado correctos en local, solitario y online.');

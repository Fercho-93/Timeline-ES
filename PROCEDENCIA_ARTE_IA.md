...
- Portada ilustrada: `assets/home-deco-left.webp`, `assets/home-deco-right.webp`, `assets/home-deco-maps.webp` y `assets/home-door-jugar.webp` se recortaron el 25 de septiembre de 2026 del mockup de la portada aportado por el titular (generado con ChatGPT/OpenAI). Se tomaron solo zonas sin texto ni controles —la columna con el olivo, el astrolabio con la ciudad, la franja de cartas marinas sobre la barra y la ilustración de cartas y esfera armilar de la lámina «Jugar»— y a las tres piezas de fondo se les añadió transparencia para que la marca, las láminas y los botones sigan siendo HTML.
- Carta náutica de fondo: `assets/paper-map.svg` no es arte generado con IA; es un dibujo vectorial del propio proyecto (retícula, rosas de los vientos, costas y rótulos) que cubre el fondo de todas las pantallas.

(function () {
  ...
  window.CONTINUUM.QuickCatalog = { version: 2, upcoming: {key: 'counts', name: '¿Cuántos hay…?', status: 'planned', axis: 'count', cards: []}, challenges: [
    ...
    d(
      'drinks',
      'Graduación de bebidas',
      'De menor a mayor porcentaje de alcohol',
      'Se comparan versiones concretas.',
      1,
      'science',
      S.drinks,
      [
        ...
        ['Tequila',38,'38 % vol.','assets/quick-cards/drinks-6.webp'],
        ['Whisky',40,'40 % vol.','assets/quick-cards/drinks-7.webp'],
    ...
    d(
      ...
      'De la primera a la última fecha',
      'Día del año en un año no bisiesto.',
      1,
      'history',
      S.dates,
      [
        ['Año Nuevo',1,'1 de enero','assets/quick-cards/festivities-1.webp'],
        ['Reyes Magos',6,'6 de enero','assets/quick-cards/festivities-2.webp'],
        ['San Valentín',45,'14 de febrero','assets/quick-cards/festivities-3.webp'],
        ['Día Internacional de la Mujer',67,'8 de marzo','assets/quick-cards/festivities-4.webp'],
        ['San Patricio',76,'17 de marzo','assets/quick-cards/festivities-5.webp'],
        ['Día del Libro',113,'23 de abril','assets/quick-cards/festivities-6.webp'],
        ['Día de Europa',129,'9 de mayo','assets/quick-cards/festivities-7.webp'],
        ['Día del Trabajo',121,'1 de mayo','assets/quick-cards/festivities-8.webp'],
        ['Día de la Música',172,'21 de junio','assets/quick-cards/festivities-9.webp'],
    ...
    d(
      ...
      'Primer lanzamiento del servicio.',
      1,
      'history',
      S.social,
      [
    ...
    d(
      ...
      S.civil,
      [
        ['Sublevación militar',19360717,'17 julio 1936','assets/quick-cards/civil-war-1.webp'],
    ...
    d(
      'kings',
      'Reyes de España',
      'Según el inicio de su reinado',
      'Se ordena el comienzo del reinado.',
      1,
      'history',
      S.kings,
      [
    ...
    d(
      ...
      'Según su primera salida al mercado',
      'Se mezclan fabricantes y generaciones.',
      1,
      'entertainment',
      S.consoles,
      [
        ...
        ['Nintendo Entertainment System',1983,'1983','assets/quick-cards/consoles-4.webp'],
    ...
    d(
      ...
      S.companies,
      [
        ['Coca-Cola',1892,'1892','assets/quick-cards/companies-founded-1.webp'],
        ['IBM',1911,'1911','assets/quick-cards/companies-founded-2.webp'],
        ['Disney',1923,'1923','assets/quick-cards/companies-founded-3.webp'],
        ['Toyota',1937,'1937','assets/quick-cards/companies-founded-4.webp'],
        ['Samsung',1938,'1938','assets/quick-cards/companies-founded-5.webp'],
        ['Sony',1946,'1946','assets/quick-cards/companies-founded-6.webp'],
        ['Microsoft',1975,'1975','assets/quick-cards/companies-founded-7.webp'],
        ['Apple',1976,'1976','assets/quick-cards/companies-founded-8.webp'],
        ['Amazon',1994,'1994','assets/quick-cards/companies-founded-9.webp'],
        ['Netflix',1997,'1997','assets/quick-cards/companies-founded-10.webp'],
        ['Google',1998,'1998','assets/quick-cards/companies-founded-11.webp'],
        ['Meta',2004,'2004','assets/quick-cards/companies-founded-12.webp']
      ]
    ),
    d(
      'timezones-june',
    ...
    d(
      ...
      'De arriba a abajo',
      'Orden anatómico aproximado en posición erguida.',
      1,
      'science',
      S.body,
      [
    ...
    d(
      ...
      'De menos a más temporadas',
      'Temporadas emitidas de la serie indicada.',
      1,
      'entertainment',
      S.series,
      [
        ...
        ['Stranger Things',4,'4 temporadas','assets/quick-cards/series-seasons-8.webp'],
    ...
    d(
      'buildings',
      'Edificios por altura',
      'De menor a mayor altura arquitectónica',
      'No se cuenta la antena.',
      1,
      'science',
      S.buildings,
      [
    ...
    d(
      'rivers-spain',
      'Ríos de España por longitud',
      'De menor a mayor longitud',
      'Longitud del río completo.',
      1,
      'globe',
      S.rivers,
      [
        ['Llobregat',175,'175 km','assets/quick-cards/rivers-spain-1.webp'],
        ['Turia',280,'280 km','assets/quick-cards/rivers-spain-2.webp'],
        ['Miño',315,'315 km','assets/quick-cards/rivers-spain-3.webp'],
        ['Segura',325,'325 km','assets/quick-cards/rivers-spain-4.webp'],
        ['Júcar',498,'498 km','assets/quick-cards/rivers-spain-5.webp'],
        ['Guadalquivir',657,'657 km','assets/quick-cards/rivers-spain-6.webp'],
        ['Guadiana',744,'744 km','assets/quick-cards/rivers-spain-7.webp'],
        ['Duero',897,'897 km','assets/quick-cards/rivers-spain-8.webp'],
        ['Ebro',930,'930 km','assets/quick-cards/rivers-spain-9.webp'],
        ['Tajo',1007,'1.007 km','assets/quick-cards/rivers-spain-10.webp']
      ]
    ),
    d(
      'foods-kcal',
      'Alimentos por calorías',
      'De menos a más kilocalorías por 100 g',
      'Valores estándar; pueden variar según preparación.',
      1,
      'science',
      S.food,
      [
    ...
    d(
      'albums-sales',
      'Discos por ventas',
      'De menos a más copias vendidas',
      'Estimaciones acumuladas; se indica el mercado cuando no es mundial.',
      1,
      'entertainment',
      S.albums,
      [
        ...
        ['Their Greatest Hits 1971–1975',42,'42 millones en EE. UU.','assets/quick-cards/albums-sales-8.webp'],
        ['Thriller',70,'≈70 millones','assets/quick-cards/albums-sales-9.webp']
      ]
    ),
    d(
      'stadiums',
      'Estadios de fútbol por capacidad',
      'De menor a mayor capacidad',
      'La capacidad puede variar por obras.',
      1,
      'sports',
      S.stadiums,
      [
    ...
    d(
      'capitals-altitude',
      'Capitales del mundo por altitud',
      'De menor a mayor altitud',
      'Altitud aproximada del centro urbano.',
      1,
      'globe',
      S.capitals,
      [
    ...
    d(
      ...
      'De menor a mayor capacidad decimal',
      'Sistema decimal SI, no unidades binarias.',
      1,
      'science',
      S.storage,
      [
    ...
    d(
      'airports',
      'Aeropuertos por pasajeros',
      'De menos a más pasajeros en 2025',
      'Pasajeros totales según ACI World.',
      1,
      'globe',
      S.airports,
      [
        ['Londres-Heathrow',83.9,'≈83,9 millones','assets/quick-cards/airports-1.webp'],
        ['Denver',82.4,'≈82,4 millones','assets/quick-cards/airports-2.webp'],
        ['Chicago O’Hare',83.6,'≈83,6 millones','assets/quick-cards/airports-3.webp'],
    ...
    d(
      'metros',
      'Redes de metro por longitud',
      'De menor a mayor longitud de red',
      'Tamaño significa longitud total de la red.',
      1,
      'globe',
      S.metro,
      [
    ...
    d(
      ...
      S.fortune,
      [
        ['Apple',383,'≈383 mil M$','assets/quick-cards/companies-revenue-1.webp'],
        ['China National Petroleum',421,'≈421 mil M$','assets/quick-cards/companies-revenue-2.webp'],
        ['Sinopec',429,'≈429 mil M$','assets/quick-cards/companies-revenue-3.webp'],
        ['UnitedHealth Group',447.5,'≈447,5 mil M$','assets/quick-cards/companies-revenue-4.webp'],
        ['Saudi Aramco',480,'≈480 mil M$','assets/quick-cards/companies-revenue-5.webp'],
        ['State Grid',545,'≈545 mil M$','assets/quick-cards/companies-revenue-6.webp'],
        ['Amazon',638,'≈638 mil M$','assets/quick-cards/companies-revenue-7.webp'],
        ['Walmart',681,'≈681 mil M$','assets/quick-cards/companies-revenue-8.webp']
      ]
    ),
    d(
      'spanish-tv',
    ...
    d(
      'minimum-wages',
      'Países por salario mínimo',
      'De menor a mayor salario mínimo bruto mensual',
      'Comparación nominal en euros; solo países con salario nacional.',
      1,
      'science',
      S.wages,
      [
        ['Bulgaria',620,'620 €/mes','assets/quick-cards/minimum-wages-1.webp'],
        ['Rumanía',795,'795 €/mes','assets/quick-cards/minimum-wages-2.webp'],
        ['Polonia',1100,'≈1.100 €/mes','assets/quick-cards/minimum-wages-3.webp'],
        ['España',1323,'1.323 €/mes en 14 pagas','assets/quick-cards/minimum-wages-4.webp'],
        ['Francia',1823,'1.823 €/mes','assets/quick-cards/minimum-wages-5.webp'],
        ['Bélgica',2112,'2.112 €/mes','assets/quick-cards/minimum-wages-6.webp'],
        ['Países Bajos',2295,'2.295 €/mes','assets/quick-cards/minimum-wages-7.webp'],
        ['Alemania',2343,'2.343 €/mes','assets/quick-cards/minimum-wages-8.webp'],
        ['Irlanda',2391,'2.391 €/mes','assets/quick-cards/minimum-wages-9.webp'],
        ['Luxemburgo',2704,'2.704 €/mes','assets/quick-cards/minimum-wages-10.webp']
      ]
    ),
    ...
    d(
      ...
      'Póker alto de cinco cartas, sin comodines.',
      1,
      'entertainment',

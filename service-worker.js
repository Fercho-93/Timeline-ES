...
const CACHE = "continuum-v6";
const ASSETS = ["./", "./index.html", "./styles.css", "./cards.js", "./movies.js", "./inventos.js", "./mundo.js", "./countries.js", "./population.js", "./modes.js", "./drag.js", "./app.js", "./online.js", "./manifest.webmanifest", "./icon.svg", "./assets/hero-history.jpg", "./assets/hero-cinema.jpg", "./assets/hero-geography.jpg"];

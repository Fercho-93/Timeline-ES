...
const CACHE = "continuum-v3";
const ASSETS = ["./", "./index.html", "./styles.css", "./cards.js", "./movies.js", "./countries.js", "./population.js", "./modes.js", "./app.js", "./online.js", "./manifest.webmanifest", "./icon.svg", "./assets/hero-history.jpg", "./assets/hero-cinema.jpg", "./assets/hero-geography.jpg"];
